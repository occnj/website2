            ...
            <div className="featured-event-body">
              <div>
                ...
                <h2 style={{ fontFamily: 'var(--font-head)', fontSize: 'clamp(1.4rem,3vw,2rem)', fontWeight: 700, color: '#fff', lineHeight: 1.1, marginBottom: 'var(--sp-2)' }}>
                  {featured ? featured.title : 'Baptism Sunday'}
                </h2>
                <p style={{ color: 'rgba(255,255,255,.6)', fontSize: '.9rem', lineHeight: 1.65 }}>
                  {featured ? featured.description : 'An unforgettable morning of celebration as members of our community take the step of baptism. Open to all — bring your family.'}
                </p>
                <div style={{ display: 'flex', gap: 'var(--sp-3)', marginTop: 'var(--sp-3)', fontSize: '.82rem', color: 'rgba(255,255,255,.55)', flexWrap: 'wrap' }}>
                  {featured ? (
                    ...
                    <>
                      <span>April 27, 2026</span><span>·</span><span>10:00 AM</span><span>·</span><span>Main Sanctuary</span>
                    </>
                  )}
                </div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)', alignItems: 'flex-start' }}>
                <a href={(featured && featured.registration_url) || '#'} className="btn btn-primary">Learn More</a>
                <a href="#" className="btn btn-ghost btn-sm">Add to Calendar</a>
              </div>
            </div>
          </div>
